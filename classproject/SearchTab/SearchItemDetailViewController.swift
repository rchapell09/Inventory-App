...
class SearchItemDetailViewController: UIViewController, UIImagePickerControllerDelegate,
UINavigationControllerDelegate{
    ...
    @IBAction func decquan(_ sender: Any) {
        if(quant!>0){
            quant! = quant! - 1
    ...
    @IBAction func incquan(_ sender: Any) {
        quant! = quant! + 1
        quantlabel.text = String(quant!)
    }
